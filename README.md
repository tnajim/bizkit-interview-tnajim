...
6. Run the application with the command:
    ```
    flask --app phasebook --debug run --port 7000
    ```
7. Open the url printed on the terminal: `http://127.0.0.1:7000` using your browser or a tool like [Postman](https://www.postman.com). You should get a text saying `Hello World!`.
...
- The match endpoint is: http://127.0.0.1:7000/match/{match_id}.
...
- You can use the following `{match_id}` to test: `0`, `1`, `2`, `3`. Example: http://127.0.0.1:7000/match/3.
...
### Technical Information
- The search endpoint is: http://127.0.0.1:7000/search. The user can pass the following query parameters:
  - id
  - name
  - age
  - occupation
...
- Example calls to the search endpoint are:
  - http://127.0.0.1:7000/search?id=1
  - http://127.0.0.1:7000/search?name=Joe
  - http://127.0.0.1:7000/search?id=5&name=Joe&age=25&occupation=Dev
...
```
- **Request:** http://127.0.0.1:7000/search?id=1
...
- **Request:** http://127.0.0.1:7000/search?id=2&name=John
...
- **Request:** http://127.0.0.1:7000/search?age=28
...
- **Request:** http://127.0.0.1:7000/search?id=5&name=Joe&age=30&occupation=Arc
...
That means that with the examples above, the following request: http://127.0.0.1:7000/search?id=5&name=Joe&age=30&occupation=Arc, should return:
```
  [
    {"id": "5", "name": "Jane Smith", "age": 31, "occupation": "Manager"},
    {"id": "3", "name": "Joe Doe", "age": 25, "occupation": "Designer"},
